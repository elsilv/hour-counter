...
export const ProjectsUsed = (props) => {
  const { deleteProject, changeCompleted, editProject } =
  ...
  const label = props.projects.completed ? ( <AiIcons.AiOutlineCheckSquare size={20} /> ) 
                                         : ( <AiIcons.AiOutlineBorder size={20} /> );
  ...
  return (
    <>
      ...
      <div className="one-project">
        ...
        <p>
          Hours planned to use: <span>{amountProps}</span>
        </p>
        <p>{props.projects.description}</p>
        <p className="icons">
          <u className="p2">
            <Link
              data-tip="On project page"
              className="project-list-btn"
              id="page-link"
              to={`/projects/${props.projects._id}`}
            >
              <AiIcons.AiOutlineFolderOpen size={20} />
            </Link>
          </u>
          <u className="p2">
            <button
            ...
            <Modal
              ...
              <form onSubmit={onSubmit}>
                ...
                <input
                  ...
                  placeholder={props.projects.name}
                />
                ...
                <input
                  ...
                  placeholder={props.projects.amount}
                />
                ...
                <input
                  ...
                  placeholder={props.projects.description}
                />
                <button> Save </button>
              </form>
            </Modal>
          ...
          <u className="p2">
            <button
              ...
              onClick={() => deleteProject(props.projects._id)}
            >
          ...
          <u className="p2">
            <button
              data-tip="Mark project as completed"
              className="project-list-btn"
              onClick={() => changeCompleted(props.projects._id)}
            >
              {label}
            </button>
          </u>
